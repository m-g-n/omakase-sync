...
## 更新履歴
### 0.2.22
- 設定画面でAPIキーを平文表示しないように修正
- アンインストール時にAPIキーとスケジュールを削除するように修正
- 自動更新のパッケージURLを検証してから適用するように修正

### 0.2.20
- 必要な関数が読み込まれる前に自動更新のための処理が走らないように修正
### 0.2.19
- 自動更新のコードにて、WordPress関数が名前空間込みで実行されるバグ修正
### 0.2.18
- 自動更新のバグ修正、テストのためのバージョンアップ
### 0.2.16
- 自動更新機能のコードを修正
### 0.2.15
